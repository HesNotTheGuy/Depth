...
export function ExportPanel() {
  ...
  const handleExportPNG = useCallback(async () => {
    ...
    setStatus('Rendering...');
    try {
      await captureComposite(renderer, scene, camera, exportScale, exportFilename);
  ...
  }, [renderer, scene, camera, exportScale, exportFilename]);
  ...
  const handleExportLayers = useCallback(async () => {
    ...
    try {
      await captureLayered(renderer, scene, camera, exportScale, exportFilename);
